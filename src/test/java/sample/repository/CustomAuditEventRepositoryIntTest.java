...
import sample.config.audit.AuditEventConverter;
import sample.domain.PersistentAuditEvent;
...
import static sample.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
