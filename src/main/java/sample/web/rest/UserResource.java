...
import sample.config.Constants;
import com.codahale.metrics.annotation.Timed;
import sample.domain.User;
import sample.repository.UserRepository;
import sample.repository.search.UserSearchRepository;
import sample.security.AuthoritiesConstants;
import sample.service.MailService;
import sample.service.UserService;
import sample.service.dto.UserDTO;
import sample.web.rest.errors.BadRequestAlertException;
import sample.web.rest.errors.EmailAlreadyUsedException;
import sample.web.rest.errors.LoginAlreadyUsedException;
import sample.web.rest.util.HeaderUtil;
import sample.web.rest.util.PaginationUtil;
